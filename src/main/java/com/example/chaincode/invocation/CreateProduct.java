...
/**
 * Invoke CreateProduct Chaincode.
 * 
 * @author Mopack
 * @date 2020-07-14
 */
	...
	public static void main(String args[]) {
		try {
			...
			for (ProposalResponse res: responses) {
				...
				Logger.getLogger(CreateProduct.class.getName()).log(Level.INFO,"Invoked " + Config.CHAINCODE_1_CREATE_PRODUCT + " on "+Config.CHAINCODE_1_NAME + ". Status - " + status);
			}
