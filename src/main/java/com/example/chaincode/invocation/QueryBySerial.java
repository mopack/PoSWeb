...
/**
 * Invoke QueryBySerial Chaincode.
 * 
 * @author Mopack
 * @date 2020-07-14
 */
public class QueryBySerial {
	...
	public static void main(String args[]) {
		try {
			...
			String[] args1 = {Config.CHAINCODE_1_INDEX_PREFIX + args[0]};
			Logger.getLogger(QueryBySerial.class.getName()).log(Level.INFO, "Querying for a product - " + args1[0]);
			...
			for (ProposalResponse pres : responses1Query) {
				...
				Logger.getLogger(QueryBySerial.class.getName()).log(Level.INFO, stringResponse);
			}		
