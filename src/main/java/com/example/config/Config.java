...
public class Config {
	...
	public static final String CHAINCODE_1_NAME = "fabricdemo";
	
	public static final String CHAINCODE_1_PATH = "github.com/fabricdemo";
	
	public static final String CHAINCODE_1_VERSION = "1";

	public static final String CHAINCODE_1_CREATE_PRODUCT = "createProduct";
	
	public static final String CHAINCODE_1_QUERY_BY_SERIAL = "queryBySerial";
	
	public static final String CHAINCODE_1_CHANGE_CONSUMER = "changeConsumer";
	
	public static final String CHAINCODE_1_QUERY_ALL = "queryAll";
	
	public static final String CHAINCODE_1_INDEX_PREFIX = "PRODUCT";

	public static final String EVENT_HUP_1_NAME = "eventhub01";
	
	public static final String EVENT_HUP_1_URL = "grpc://localhost:7053";
